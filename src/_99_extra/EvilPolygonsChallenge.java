...
rob.setSpeed(100);
		int colorChoice=JOptionPane.showOptionDialog(null, "what color do you want?", "a pop-up", JOptionPane.INFORMATION_MESSAGE, JOptionPane.DEFAULT_OPTION, null, new String[]{"red","green", "blue"}, 0);
